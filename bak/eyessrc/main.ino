...
void setup() {
    ...
    roboEyes.setWidth(50, 50);   // byte leftEye, byte rightEye
    roboEyes.setHeight(50, 50);  // byte leftEye, byte rightEye
    roboEyes.setBorderradius(16, 16); // byte leftEye, byte rightEye
