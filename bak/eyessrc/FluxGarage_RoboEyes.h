...
#define BGCOLOR TFT_BLACK    // background and overlays
#define MAINCOLOR TFT_CYAN  // drawings
...
class RoboEyes {
   ...
   public:
    ...
    int screenWidth = 240;       // OLED display width, in pixels
    int screenHeight = 135;      // OLED display height, in pixels
    ...
    void begin(int width, int height, byte frameRate) {
        ...
        sprite.fillSprite(TFT_BLACK);  // fill entire screen with black (clear screen)
    ...
    void drawEyes() {
        ...
        sprite.fillSprite(TFT_BLACK);  // start with a blank screen
        ...
        sprite.pushSprite(0, 0);
        // tft.display();  // show drawings on display
